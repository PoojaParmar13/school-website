...
const Students = () => {
  return (
    <div className="bg-gray-200 md:px-8  px-4  pb-8 pt-[7rem] border-gray-800 border-4">
      ...
      <div className="max-w-7xl mx-auto">
        <section className="mb-12 md:flex">
          ...
          <div className="md:w-3/5 w-full">
            <p className="text-lg  mr-[-2rem] text-gray-950 font-semibold mt-8 pr-10">
        ...
        <section className="mb-4">
          <h1 className="text-3xl font-bold text-gray-700 mb-8 text-center">Campus Facilities</h1>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={campusImage1} alt="Campus View 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={campusImage2} alt="Campus View 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={campusImage3} alt="Campus View 3" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={campusImage4} alt="Campus View 4" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
              </Carousel>
            </div>
          </div>
        ...
        {/* Science Labs */}
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Science Labs</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={labImage1} alt="Lab View 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage2} alt="Lab View 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage3} alt="Lab View 3" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage4} alt="Lab View 4" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage5} alt="Lab View 5" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage6} alt="Lab View 6" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
              </Carousel>
            </div>
          </div>
        ...
        {/* ATAL Tinkering Lab */}
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">ATAL Tinkering Lab</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={labImage7} alt="Lab View 7" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={labImage8} alt="Lab View 8" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
              </Carousel>
            </div>
          </div>
        ...
        {/* Computer Lab */}
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Computer Lab</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={computerImage1} alt="Computer Lab View 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={computerImage2} alt="Computer Lab View 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={computerImage3} alt="Computer Lab View 3" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
              </Carousel>
            </div>
          </div>
        ...
        {/* Library */}
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Library</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={libraryImage1} alt="Library View 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={libraryImage2} alt="Library View 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
              </Carousel>
            </div>
          </div>
        ...
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Transport Facilities</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              <img src={transportImage} alt="Transport Facilities" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
            </div>
          </div>
        </section>
        <hr className="border-black mb-12" />
        ...
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Extracurricular Activities, Clubs, and Societies</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={extracarriculam1} alt="Extracurricular Activities 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={extracarriculam2} alt="Extracurricular Activities 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={extracarriculam3} alt="Extracurricular Activities 3" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>              
                </Carousel>
            </div>
          </div>
        ...
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Achievements and Accolades</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={achievments1} alt="Achievements 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={achievments2} alt="Achievements 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={achievments3} alt="Achievements 3" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>             
                </Carousel>
            </div>
          </div>
        ...
        <section className="mb-4">
          <h2 className="text-3xl font-bold text-gray-700 mb-8 text-center">Student Council and Leadership Opportunities</h2>
          <div className="md:flex">
            <div className="md:w-3/5 w-full pr-4">
              <p className="text-lg text-gray-800 my-4 mx-4">
            ...
            <div className="md:ml-[8rem] md:mt-[2rem] mt-0 ml-[3.5rem] md:w-2/5 md:pr-4 w-[18rem] md:pl-0">
              ...
              >
                <div>
                  <img src={council1} alt="Student Council 1" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>
                <div>
                  <img src={council2} alt="Student Council 2" className="rounded-lg shadow-black shadow-lg w-full h-auto object-cover" />
                </div>              
                </Carousel>
            </div>
          </div>
