const AboutUs = () => {
  return (
    <div className="md:px-8 md:pb-8 px-2 pb-8 bg-gray-200 md:pt-[7rem] pt-[6rem] border-gray-800 border-4">
      <h1 className="text-3xl font-bold text-gray-600 mb-8 text-center underline">About Us</h1>
      <div className="md:mx-10 mx-1 bg-white my-2 p-4 rounded shadow-md border border-gray-600">
      {/* History */}
