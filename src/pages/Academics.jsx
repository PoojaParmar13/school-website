...
const Academics = () => {
  return (
    <div className="md:px-8 md:pb-8 p-2 bg-gray-200 md:pt-[7rem] pt-[6rem] border-gray-800 border-4">
        <h1 className="text-3xl font-bold text-gray-600 mb-8 text-center underline">Academics at Springdale Public School</h1>
        <div className="md:mx-40 mx-1 md:px-10 px-4 bg-white my-2 p-4 rounded shadow-md border border-gray-600">

        {/* Curriculum */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-gray-700 underline pb-4 ">Curriculum</h2>
          <div className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-semibold text-gray-700 underline pb-4">Teaching Methodologies</h2>
          <p className="text-lg text-gray-700">
        ...
        <section className="mb-4 flex flex-col sm:flex-row items-start">
          <div className="flex-1 mb-6 sm:mb-0">
            <h2 className="text-3xl font-semibold text-gray-700 underline pb-4">Educational Resources</h2>
            <p className="text-lg text-gray-700 mb-4">
              Our educational resources include:
              <ul className="list-disc pl-5 mt-2 text-gray-700 pb-4">
