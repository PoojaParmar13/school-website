const Admissions = () => {
  return (
    <div className="md:px-8 md:pb-8 p-2 bg-gray-200 md:pt-[7rem] pt-[6rem] border-gray-800 border-4">
        <h1 className="text-3xl font-bold text-gray-600 mb-8 text-center underline">Admissions at Springdale Public School</h1>
        <div className="max-w-4xl mx-auto bg-white md:p-8 p-4 rounded border  border-gray-600">
        {/* Admission Overview */}
        <section className="mb-8">
          <h2 className="md:text-3xl text-[1.5rem] font-semibold text-black mb-4">Admission Overview</h2>
        ...
        <section className="mb-8">
          <h2 className="md:text-3xl text-[1.5rem] font-semibold text-black mb-4">Admission Process and Criteria</h2>
          <p className="text-lg text-gray-700 mb-4">
        ...
        {/* Important Dates */}
        <section className="mb-8">
          <h2 className="md:text-3xl text-[1.5rem] font-semibold text-black mb-4">Important Dates</h2>
        ...
        {/* Required Documents */}
        <section className="mb-8">
          <h2 className="md:text-3xl text-[1.5rem] font-semibold text-black mb-4">Required Documents</h2>
          <ul className="list-disc pl-5 text-lg text-gray-700">
        ...
        {/* Contact Information */}
        <section>
          <h2 className="md:text-3xl text-[1.5rem] font-semibold text-black mb-4">Contact Information</h2>
          <p className="text-lg text-gray-700 mb-4">
          ...
          <p className="text-lg text-gray-700 mb-2"><strong>Email:</strong> admissions@springdale.edu</p>
          <p className="text-lg text-gray-700"><strong>Address:</strong> Springdale Public School, 123 Education Lane, Cityville, State, ZIP Code</p>
        </section>
      </div>
    </div>
  );
