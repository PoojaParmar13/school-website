...
const ApplyNow = () => {
  ...
  return (
    <div className="p-8 bg-gray-200 border-gray-800 border-4">
      <h1 className="text-3xl font-bold text-gray-600 mb-8 text-center underline">Apply Now</h1>
      <div className="mx-40 bg-white my-2 py-4 px-12 rounded shadow-md border border-gray-600">
          ...
          {step === 2 && (
            <>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <label htmlFor="aadharNumber" className="block text-lg font-medium text-gray-700">Aadhar Number</label>
                  <input 
                    type="text" 
                    id="aadharNumber" 
                    name="aadharNumber" 
                ...
                <div>
                  <label htmlFor="aadharCard" className="block text-lg font-medium text-gray-700">Upload Aadhar Card</label>
                  <input 
                    type="file" 
                    id="aadharCard" 
                    name="aadharCard" 
